  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a URL security analyzer. Analyze the given URL and provide a security assessment with a confidence score (1-100) and top 3 reasons for the score. Format your response as JSON with fields: score, reasons (array of 3 strings)."
        },
        {
          role: "user",
